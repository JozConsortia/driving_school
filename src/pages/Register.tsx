  ...
  return (
    <AuthBackground>
      <div className="mx-auto w-full max-w-sm">
        <h1 className="text-center text-2xl font-extrabold text-white drop-shadow-sm">Create an account</h1>
        <p className="mt-1 text-center text-sm text-violet-100">Join DriveSmart in a minute</p>
        ...
        <p className="mt-4 text-center text-sm text-violet-100">
          ...
          <Link to="/login" className="font-semibold text-white hover:text-violet-200">
            Log in
          </Link>
        </p>
      </div>
